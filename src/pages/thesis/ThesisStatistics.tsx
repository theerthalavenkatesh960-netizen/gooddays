  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-teal-700">Study Statistics</h1>
      ...
      <div className="grid md:grid-cols-4 gap-4">
        ...
        >
          ...
          <div className="text-3xl font-bold mb-1">{totalRecruited}</div>
          <div className="text-sm opacity-90">Total Recruited</div>
        ...
        >
          ...
          <div className="text-3xl font-bold mb-1">{completedFollowups}</div>
          <div className="text-sm opacity-90">Follow-ups Completed</div>
        ...
        >
          ...
          <div className="text-3xl font-bold mb-1">{dropouts}</div>
          <div className="text-sm opacity-90">Dropouts</div>
        ...
        <motion.div
          ...
          className="bg-gradient-to-br from-purple-500 to-purple-600 rounded-2xl shadow-md p-6 text-white"
        >
          <div className="flex items-center justify-between mb-2">
            <CheckCircle2 size={24} />
          </div>
          <div className="text-3xl font-bold mb-1">{consentRate}</div>
          <div className="text-sm opacity-90">Consents Obtained</div>
          ...
          <div className="flex items-center gap-8">
            <div className="relative w-48 h-48">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <div className="text-xl font-bold text-white">{malePercent}%</div>
                </div>
              </div>
            </div>
            ...
            <div className="flex-1 space-y-4">
              ...
              <div className="pt-4 border-t">
                ...
                <div className="text-2xl font-bold text-gray-800">{totalGender}</div>
              </div>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="flex items-end justify-around h-48 gap-3">
            {ageGroupLabels.map((age, idx) => {
              ...
              return (
                <div key={age} className="flex-1 flex flex-col items-center gap-2">
      ...
      <motion.div
        ...
        className="bg-white rounded-2xl shadow-md p-6"
      >
        <h2 className="text-xl font-bold text-gray-800 mb-6">Monthly Recruitment Trend</h2>
      ...
      <motion.div
        ...
        className="bg-white rounded-2xl shadow-md p-6"
      >
        <h2 className="text-xl font-bold text-gray-800 mb-6">Group Performance</h2>
          ...
          {Object.entries(groupStats).map(([group, stats]: [string, any]) => (
            <div key={group} className="border rounded-lg p-4">
              <div className="flex items-center justify-between mb-3">
                ...
                <span className="text-sm text-gray-600">{stats.recruited} patients</span>
              </div>

              <div className="grid grid-cols-3 gap-4">
                <div className="text-center p-3 bg-blue-50 rounded-lg">
                  <div className="text-2xl font-bold text-blue-600">{stats.recruited}</div>
                ...
                <div className="text-center p-3 bg-red-50 rounded-lg">
                  <div className="text-2xl font-bold text-red-600">{stats.dropouts}</div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div>
            <div className="flex items-center justify-between mb-2">
              ...
              <span className="font-semibold text-gray-800">{consentPercent}%</span>
            </div>
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              <span className="text-sm text-gray-600">Inclusion Criteria</span>
              <span className="font-semibold text-gray-800">{inclusionPercent}%</span>
            </div>
            <div className="w-full bg-gray-200 rounded-full h-3">
              <div
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              <span className="text-sm text-gray-600">Follow-up Completion</span>
              <span className="font-semibold text-gray-800">{followupPercent}%</span>
            </div>
            <div className="w-full bg-gray-200 rounded-full h-3">
              <div
