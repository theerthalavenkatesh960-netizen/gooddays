-- =============================================================================
-- Seed: master_meal_templates G�� Comprehensive Indian Meal Library
...
('Paneer Scramble with Multigrain Toast', 'breakfast', '07:30',
 ...
 'Saut+� capsicum and onion. Add crumbled paneer and beaten eggs. Scramble together with spices. Serve on multigrain toast.',
 565, 32, 39, 31,
 95,
 'GOAL: Muscle Building. NOTES: Very high protein combination of paneer + eggs. Complete amino acid profile. High calorie breakfast suited for bulking phases. Pair with a glass of milk for extra protein.'),
...
('Egg White Omelette with Sprouted Moong', 'breakfast', '07:00',
 ...
 205, 26, 20, 2.3,
 55,
 'GOAL: Muscle Building, Weight Loss. NOTES: Very high protein, very low fat, low calorie. Egg whites provide pure lean protein; moong sprouts add plant protein and fibre. Excellent for cutting phase with muscle retention.'),
...
('Masala Egg Fried Rice (Leftover Rice)', 'breakfast', '08:00',
 ...
 515, 24.5, 57.5, 19.5,
 55,
 'GOAL: Muscle Building. NOTES: High protein, high carb breakfast that uses leftover rice. Quick meal prep option. Good post-morning workout or for active mornings. High calorie for bulking.'),
...
('Soya Chunk Poha', 'breakfast', '08:00',
 ...
 365, 20.7, 52.5, 6.3,
 40,
 'GOAL: Muscle Building. NOTES: Regular poha upgraded with soya chunks for high plant protein. Great for vegetarians targeting muscle gain. Affordable and filling.'),

-- =============================================================================
-- BREAKFAST G�� Weight Loss / Fat Loss
-- =============================================================================
...
('Greek-style Hung Curd with Fruit', 'breakfast', '08:00',
 ...
 213, 11.6, 31, 5.7,
 50,
 'GOAL: Weight Loss. NOTES: High protein, low calorie, probiotic-rich. Hung curd is Indian-style Greek yoghurt. Papaya aids digestion and fat metabolism. Low glycaemic index. Excellent for maintaining muscle during calorie deficit.'),
...
('Ragi Dosa with Coconut Chutney', 'breakfast', '08:00',
 ...
 305, 10.3, 47, 8,
 35,
 'GOAL: Weight Loss, Maintaining Health. NOTES: Ragi is extremely high in calcium and dietary fibre. Very low glycaemic index G�� ideal for diabetics and those managing weight. Keeps you full for 4+ hours. Rich in iron for hair health too.'),
...
('Vegetable Daliya Porridge (Savoury)', 'breakfast', '07:30',
 ...
 225, 7.5, 43, 3.2,
 30,
 'GOAL: Weight Loss. NOTES: High fibre, low fat, whole grain breakfast. Broken wheat is slow-digesting and very filling. Excellent choice for sustainable calorie reduction. Suitable for breakfast or dinner.'),

-- =============================================================================
-- BREAKFAST G�� Weight Gain
-- =============================================================================
...
('Banana Peanut Butter Milkshake Breakfast Bowl', 'breakfast', '08:30',
 ...
 659, 20.8, 94.9, 25.8,
 75,
 'GOAL: Weight Gaining. NOTES: Very calorie-dense, high-carb breakfast. Excellent for hardgainers who struggle to eat large volumes of food. Blending increases caloric intake without bulk. Can be consumed quickly post-workout for glycogen replenishment.'),
...
('Ghee Rice with Moong Dal and Papad', 'breakfast', '09:00',
 ...
 520, 16.5, 85, 12,
 45,
 'GOAL: Weight Gaining. NOTES: High calorie, traditional combination. Ghee adds healthy saturated fat for calorie surplus. Suitable for underweight individuals or those in hard bulking phase. Easy on digestion.'),
...
('Suji Halwa with Milk', 'breakfast', '09:00',
 ...
 550, 14.5, 74, 22,
 55,
 'GOAL: Weight Gaining. NOTES: Traditional high-calorie Indian sweet breakfast. Dense with carbohydrates and healthy fats. Pair with milk to increase protein. Suitable for post-illness recovery and underweight individuals. Not recommended for fat loss goals.'),

-- =============================================================================
-- BREAKFAST G�� Health Maintenance / Leafy Vegetables / Hair Care
-- =============================================================================
...
('Palak Moong Dal Chilla', 'breakfast', '08:00',
 ...
 190, 14.2, 30, 2.8,
 30,
 'GOAL: Maintaining Health. NOTES: Spinach is rich in iron, folate and biotin G�� key nutrients for hair growth and scalp health. Moong dal provides plant protein for keratin production. Low calorie, high nutrient density. Excellent daily breakfast.'),
...
('Methi Paratha with Curd', 'breakfast', '08:30',
 ...
 270, 10.7, 43.5, 5.5,
 35,
 'GOAL: Maintaining Health. NOTES: Methi (fenugreek) is one of the best foods for hair health G�� rich in iron, folic acid and protein. It also stabilises blood sugar and aids digestion. A nutritious daily breakfast option.'),
...
('Poha with Curry Leaves and Peanuts', 'breakfast', '07:30',
 ...
 313, 7.7, 41.3, 12.4,
 28,
 'GOAL: Maintaining Health. NOTES: Curry leaves are exceptionally rich in antioxidants and are traditionally used for hair loss prevention. Peanuts add protein and biotin. Iron-rich turmeric reduces inflammation. Light, energising and quick breakfast.'),

-- =============================================================================
-- LUNCH G�� Muscle Building
-- =============================================================================
...
('Chicken Biryani (Brown Rice)', 'lunch', '13:00',
 ...
 515, 40, 61, 11.6,
 120,
 'GOAL: Muscle Building. NOTES: High protein, complex carbohydrate meal. Brown rice provides slow-releasing energy and extra fibre. Excellent anabolic lunch for gym-goers. Meal-prep friendly G�� scales easily for bulk cooking.'),
...
('Soya Chunk Curry with Jeera Rice', 'lunch', '13:00',
 ...
 495, 32.5, 72, 10.5,
 55,
 'GOAL: Muscle Building. NOTES: Soya chunks are the highest plant-based protein source available in India at under G�60/meal. 26g protein from soya alone. Complete meal for vegetarian athletes. Very affordable.'),
...
('Egg Curry with Brown Rice', 'lunch', '13:00',
 ...
 620, 31.5, 61, 28,
 75,
 'GOAL: Muscle Building. NOTES: Very high protein, high calorie lunch. Eggs provide complete amino acids. Affordable muscle-building meal. Brown rice keeps insulin response moderate for sustained energy.'),
...
('Mutton Keema with Roti', 'lunch', '13:30',
 ...
 590, 39, 59, 23.8,
 130,
 'GOAL: Muscle Building. NOTES: Very high protein non-veg meal. Mutton keema is extremely rich in B12, iron, zinc G�� essential for muscle recovery and testosterone production. Recommend 2x per week maximum.'),
...
('Paneer Tikka Wrap (Whole Wheat)', 'lunch', '13:00',
 ...
 410, 22.5, 37.5, 18.8,
 90,
 'GOAL: Muscle Building, Weight Loss. NOTES: High protein, portable and office-friendly lunch. Grilled paneer retains protein without extra calories from deep frying. Good macros for mid-cut or lean-bulk phase.'),

-- =============================================================================
-- LUNCH G�� Weight Loss / Fat Loss
-- =============================================================================
...
('Moong Dal Soup with Roti', 'lunch', '13:00',
 ...
 275, 14.7, 50, 2.2,
 35,
 'GOAL: Weight Loss. NOTES: Very low calorie, high protein and fibre lunch. The soup volume creates satiety without high calories. Spinach adds iron and vitamins. Ideal for strict calorie deficit days.'),
...
('Grilled Chicken Salad (Indian Style)', 'lunch', '13:00',
 ...
 265, 35, 11, 8.3,
 100,
 'GOAL: Weight Loss. NOTES: Very high protein, very low calorie lunch. Indian spiced salad format makes it flavourful without heavy dressing. Keeps insulin low. Excellent for strict cutting days. Pair with buttermilk for extra protein and probiotics.'),
...
('Vegetable Clear Soup with Brown Rice', 'lunch', '12:30',
 ...
 200, 5.8, 41, 1.2,
 30,
 'GOAL: Weight Loss. NOTES: Extremely low calorie, high volume meal. Vegetable broth fills the stomach without significant calories. Brown rice provides minimal complex carbs. Excellent for 1200-1400 kcal diet plans.'),
...
('Tinda (Apple Gourd) Sabzi with Jowar Roti', 'lunch', '13:00',
 ...
 290, 8.5, 52, 5.8,
 30,
 'GOAL: Weight Loss. NOTES: Tinda is one of the lowest-calorie vegetables available. Jowar roti is gluten-free with high fibre and iron. Traditional Indian weight management meal. Very filling for the calories.'),
...
('Lauki (Bottle Gourd) Dal', 'lunch', '13:00',
 ...
 280, 14.5, 42, 4.4,
 30,
 'GOAL: Weight Loss, Maintaining Health. NOTES: Lauki is extremely low calorie (95% water) and aids kidney health. It is one of the most traditional Indian vegetables for weight management. Very easy on the digestive system.'),
...
('Double Roti Chole with Butter', 'lunch', '13:30',
 ...
 540, 21.5, 87, 14,
 70,
 'GOAL: Weight Gaining. NOTES: High calorie, high carb and protein meal. Chole is extremely nutrient dense. Butter adds healthy fat and calories. Good for underweight individuals needing calorie surplus without excessive volume eating.'),
...
('Mutton Rogan Josh with Naan', 'lunch', '13:30',
 ...
 890, 46, 100, 34,
 200,
 'GOAL: Weight Gaining. NOTES: Very high calorie meal. Excellent for individuals recovering from illness or significantly underweight. Bone-in mutton provides collagen, marrow, zinc and B12 in addition to high protein. Weekend/occasional meal.'),
...
('Rice, Dal, Sabzi, Curd, Papad (Full Thali)', 'lunch', '13:00',
 ...
 735, 26.5, 117, 15.5,
 80,
 'GOAL: Weight Gaining, Maintaining Health. NOTES: Traditional full Indian thali. Nutritionally complete and balanced. High calorie for gaining weight. Ghee aids fat-soluble vitamin absorption. Rotate sabzi daily for micronutrient variety.'),

-- =============================================================================
-- LUNCH G�� Health Maintenance / Leafy Vegetables
-- =============================================================================
...
('Sarson ka Saag with Makki Roti', 'lunch', '13:00',
 ...
 350, 11, 53, 10.8,
 50,
 'GOAL: Maintaining Health. NOTES: A Punjabi superfood meal. Mustard greens are extraordinarily rich in Vitamin K, C, A, and glucosinolates (anti-cancer compounds). Iron and folate support hair growth and red blood cell production. Seasonal winter meal.'),
...
('Palak Dal (Spinach Lentil)', 'lunch', '13:00',
 ...
 495, 23, 80.5, 9.7,
 45,
 'GOAL: Maintaining Health. NOTES: Iron from both spinach and dal G�� excellent for anaemia prevention and hair fall control. Vitamin C in tomato increases iron absorption. Complete protein + iron + fibre in one dal. Eat daily.'),
...
('Methi Aloo Sabzi with Dal and Roti', 'lunch', '13:00',
 ...
 475, 20.3, 84, 8.7,
 40,
 'GOAL: Maintaining Health. NOTES: Methi leaves reduce bad cholesterol, improve insulin sensitivity and are deeply beneficial for hair growth due to their lecithin content. Potato adds comfort and quick energy. Classic everyday North Indian lunch.'),
...
('Drumstick (Moringa) Sambar with Rice', 'lunch', '13:00',
 ...
 475, 19, 84, 5.5,
 50,
 'GOAL: Maintaining Health. NOTES: Drumstick (moringa) is one of the most nutrient-dense foods on earth G�� rich in Vitamin A, C, iron, calcium and amino acids. Traditionally used in South Indian cooking for immunity and hair health. Eat 2-3x per week.'),

-- =============================================================================
-- DINNER G�� Muscle Building
-- =============================================================================
...
('Chicken Lentil Soup (High Protein)', 'dinner', '20:00',
 ...
 350, 43.3, 32, 4.1,
 100,
 'GOAL: Muscle Building. NOTES: Extremely high protein, low carb dinner. Ideal before sleep for overnight muscle protein synthesis. Low on carbs to avoid fat storage at night. Easy to digest. Very filling.'),
...
('Grilled Chicken with Sauteed Vegetables and Quinoa', 'dinner', '19:30',
 ...
 'Season and grill chicken. Saut+� vegetables in olive oil with Indian spices. Serve over cooked quinoa.',
 380, 38, 30, 10.9,
 150,
 'GOAL: Muscle Building, Weight Loss. NOTES: Very high protein, moderate carb, clean dinner. Quinoa provides complete plant protein alongside chicken. Lower calorie than rice-based dinners but nutritionally superior. For intermediate-advanced fitness goals.'),
...
('Paneer Bhurji with High-Protein Dal', 'dinner', '20:00',
 ...
 380, 22.5, 32, 18,
 80,
 'GOAL: Muscle Building. NOTES: Double protein source dinner G�� paneer + lentils. Skip roti/rice to keep carbs controlled for evening meal. Good macros for muscle building without calorie excess. Easy 20-minute dinner.'),

-- =============================================================================
-- DINNER G�� Weight Loss / Fat Loss
-- =============================================================================
...
('Vegetable Khichdi (Light Version)', 'dinner', '19:30',
 ...
 295, 13, 52.5, 3.3,
 35,
 'GOAL: Weight Loss. NOTES: Light, gut-friendly dinner. One of Ayurveda''s most recommended meals for healthy digestion and weight management. Very easy to digest before sleep. Low calorie and balanced.'),
...
('Grilled Fish Tikka with Raita', 'dinner', '19:30',
 ...
 245, 33, 11.5, 6.8,
 110,
 'GOAL: Weight Loss. NOTES: Very high protein, very low calorie, no grain dinner. Ideal for strict fat loss phases. Keeps you full overnight without heavy carbs. Omega-3 from fish improves insulin sensitivity and reduces inflammation.'),
...
('Egg Drop Rasam', 'dinner', '19:30',
 ...
 198, 13.8, 11.5, 9.7,
 30,
 'GOAL: Weight Loss. NOTES: Innovative South Indian style soup-dinner. Very low calorie, high protein. Pepper and rasam spices boost metabolism. Extremely light before sleep. Great for strict diet days.'),

-- =============================================================================
-- DINNER G�� Weight Gain
-- =============================================================================
...
('Butter Chicken with Garlic Naan', 'dinner', '20:30',
 ...
 835, 49, 98, 26.6,
 160,
 'GOAL: Weight Gaining. NOTES: Very high calorie, high protein dinner. Excellent for hardgainers and bulking phase. Butter and cream provide calorie-dense healthy fats. Occasional meal G�� not for daily consumption. Best for rest days or post-heavy training.'),
...
('Aloo Paneer Paratha with Lassi', 'dinner', '20:00',
 ...
 670, 21, 84, 28,
 70,
 'GOAL: Weight Gaining. NOTES: Traditional high-calorie Indian dinner. Paneer adds protein to typical paratha. Sweet lassi adds easily consumable liquid calories and protein. Great for post-workout dinner when appetite is high.'),

-- =============================================================================
-- DINNER G�� Health Maintenance / Leafy Vegetables
-- =============================================================================
...
('Amaranth (Chaulai) Sabzi with Bajra Roti', 'dinner', '19:30',
 ...
 'Saut+� garlic in oil, add washed amaranth leaves. Cook until wilted. Season. Serve with bajra rotis.',
 245, 8.8, 38, 7.5,
 30,
 'GOAL: Maintaining Health. NOTES: Amaranth leaves are extraordinarily high in iron and calcium G�� among the richest plant sources available. Bajra (pearl millet) is rich in silica which strengthens hair shaft. Together an exceptional hair-health dinner. Very low calorie and traditional.'),
...
('Fenugreek Leaves (Methi) Dal', 'dinner', '20:00',
 ...
 380, 18, 60, 7.8,
 35,
 'GOAL: Maintaining Health. NOTES: Methi dal is deeply nourishing. Fenugreek leaves improve insulin sensitivity, lower bad cholesterol, and provide iron and folate. Chana dal is slower digesting than other lentils G�� good before sleep. Traditional and medicinal.'),
...
('Bhindi (Okra) Stir Fry with Jowar Roti', 'dinner', '20:00',
 ...
 290, 8.2, 51, 5.8,
 30,
 'GOAL: Maintaining Health, Weight Loss. NOTES: Bhindi is extremely rich in soluble fibre (mucilage) which feeds beneficial gut bacteria and slows carbohydrate absorption. Also rich in Vitamin C and folate. Jowar roti is gluten-free and high in iron. Low calorie combination.'),

-- =============================================================================
-- SNACK G�� Muscle Building
-- =============================================================================
...
('Boiled Eggs with Chaat Masala', 'snack', '16:00',
 ...
 215, 18, 2.5, 14,
 30,
 'GOAL: Muscle Building. NOTES: Quick, high-protein, portable snack. Eggs are the gold standard complete protein. Zero cooking skill required after boiling. Perfect between-meal muscle-building snack. Affordable.'),
...
('Paneer Cubes with Herbs', 'snack', '16:30',
 ...
 205, 13, 4, 15,
 50,
 'GOAL: Muscle Building. NOTES: Simple, very high protein snack. Raw paneer retains all protein without added cooking calories. Excellent for vegetarian gym-goers needing frequent protein intake through the day.'),
...
('Chana Dal Chaat', 'snack', '16:00',
 ...
 200, 12, 34, 1,
 20,
 'GOAL: Muscle Building. NOTES: Very high protein, high fibre snack. Chana dal has a lower glycaemic index than other dals. Keeps appetite suppressed for 3+ hours. Inexpensive and very satisfying.'),
...
('Cucumber and Tomato Chaat', 'snack', '16:00',
 ...
 75, 3.1, 15, 0.5,
 15,
 'GOAL: Weight Loss. NOTES: One of the lowest calorie snacks possible. Very high volume for the calorie count. Hydrating and full of fibre. Use when hunger spikes between meals during a calorie deficit. Zero guilt snack.'),
...
('Moong Dal Bhel', 'snack', '16:00',
 ...
 185, 9, 36, 0.6,
 20,
 'GOAL: Weight Loss. NOTES: Low calorie, high fibre, high protein snack. Puffed rice adds crunch without calories. Moong provides protein to stave off hunger. Much healthier than typical bhel with sev.'),
...
('Roasted Foxnuts (Makhana) with Herbs', 'snack', '17:00',
 ...
 113, 4.1, 20.7, 1.6,
 40,
 'GOAL: Weight Loss, Maintaining Health. NOTES: Makhana is low calorie, high magnesium, anti-inflammatory. Turmeric and black pepper combination is anti-inflammatory and aids metabolism. Good for evening snacking. Suitable for diabetics.'),
...
('Amla (Indian Gooseberry) Murabba', 'snack', '16:00',
 ...
 80, 0.5, 20, 0.1,
 15,
 'GOAL: Maintaining Health. NOTES: Amla is the richest known natural source of Vitamin C G�� essential for collagen production and hair strength. A single amla provides 20x more Vitamin C than an orange. Improves immunity and skin elasticity. Traditional snack with no negatives.'),
...
('Mixed Dry Fruit and Nut Trail Mix', 'snack', '16:00',
 ...
 395, 8.8, 48, 22.2,
 80,
 'GOAL: Weight Gaining. NOTES: Calorie-dense, nutrient-rich snack. Excellent for increasing daily calorie intake without eating large volumes of food. Walnuts provide omega-3; almonds provide vitamin E. Great for underweight individuals and hardgainers.'),
...
('Chikki (Peanut Jaggery Bar)', 'snack', '16:30',
 ...
 270, 8.2, 29, 15,
 20,
 'GOAL: Weight Gaining. NOTES: Traditional Indian high-calorie sweet snack. Jaggery provides iron and quick carbs; peanuts provide protein and fat. Perfect post-workout weight gain snack. Very affordable. Healthier than commercial energy bars.'),
...
('Lassi (Full Fat, Sweet)', 'snack', '16:00',
 ...
 258, 10.1, 30.7, 10,
 25,
 'GOAL: Weight Gaining. NOTES: Calorie and protein-dense liquid snack. Easy to consume when appetite is low. Probiotics from curd aid digestion. Traditional weight gain drink in North India. Can add protein powder for enhanced muscle-building version.'),

-- =============================================================================
-- JUICE G�� Health Maintenance / Hair Care
-- =============================================================================
...
('Amla Ginger Turmeric Juice', 'snack', '07:00',
 ...
 44, 0.8, 10.2, 0.3,
 20,
 'GOAL: Maintaining Health. NOTES: This juice is possibly the most powerful hair and immunity tonic in Indian tradition. Amla provides Vitamin C for collagen and keratin; turmeric is anti-inflammatory; ginger aids circulation to scalp. Drink daily on empty stomach for best results.'),
...
('Spinach Cucumber Mint Green Juice', 'snack', '07:30',
 ...
 54, 3.2, 9.9, 0.5,
 25,
 'GOAL: Weight Loss. NOTES: Extremely low calorie, high micronutrient juice. Spinach provides iron and folate for hair follicle health. Cucumber hydrates hair and scalp. Mint improves blood circulation to scalp. Excellent morning ritual for hair fall reduction.'),
...
('Carrot Beetroot Ginger Juice', 'snack', '07:00',
 ...
 110, 3.1, 26, 0.6,
 30,
 'HEALTH MAINTENANCE / HAIR CARE / FAT LOSS. Beetroot is rich in nitrates which improve blood flow G�� including to scalp for hair growth. Beta-carotene in carrots converts to Vitamin A which is essential for healthy sebum production on scalp. Iron from beetroot prevents anaemia-related hair fall. Excellent morning juice.'),
...
('Coconut Water with Lemon and Mint', 'snack', '16:00',
 ...
 56, 0.8, 11.5, 0.5,
 25,
 'GOAL: Maintaining Health. NOTES: Natural electrolyte drink G�� rich in potassium, sodium, magnesium. Excellent for hydration, preventing muscle cramps and reducing heat in the body. Low calorie and gut-friendly. Great for hot Hyderabad weather.'),
...
('Pomegranate Aloe Vera Juice', 'snack', '08:00',
 ...
 87, 1.6, 19.3, 1,
 40,
 'GOAL: Maintaining Health. NOTES: Pomegranate is rich in punicalagins which protect hair follicles from oxidative stress. Aloe vera has proteolytic enzymes that repair dead scalp cells. Together they improve scalp health, reduce dandruff and support hair growth from within. Drink 3-4x per week.'),
...
('Jeera (Cumin) Lemon Water', 'snack', '06:30',
 ...
 38, 0.5, 9, 0.4,
 10,
 'GOAL: Weight Loss, Maintaining Health. NOTES: Jeera water on empty stomach is one of the most widely recommended home remedies in India for bloating, digestion, and metabolism boost. Lemon alkalises the body and provides Vitamin C. Very low calorie. Drink before breakfast daily.'),
...
('Ash Gourd (Winter Melon) Juice', 'snack', '07:00',
 ...
 30, 1, 7, 0.2,
 20,
 'GOAL: Maintaining Health, Weight Loss. NOTES: Ash gourd juice is one of the most cooling and alkalising drinks in Ayurveda. Extremely low calorie. Said to improve mental clarity, reduce acidity, and assist in weight management. Best consumed on empty stomach.'),
...
('Sugarcane Ginger Juice', 'snack', '16:00',
 ...
 123, 0.4, 30.2, 0.3,
 15,
 'GOAL: Weight Gaining. NOTES: Natural fast-acting carbohydrate source. Very popular pre-workout or post-workout drink in Indian street culture. Provides instant glycogen. Rich in iron, potassium and natural enzymes. Not suitable for diabetics or fat loss phases.'),
...
('Banana with Milk', 'pre-workout', '06:30',
 ...
 240, 9.1, 35, 8.3,
 25,
 'GOAL: Muscle Building. NOTES: Simple, traditional Indian pre-workout. Banana provides fast carbs for energy; milk provides casein protein which is slow-releasing G�� keeps amino acids available during the workout. Eat 30-45 minutes before training.'),
...
('Poha with Roasted Peanuts (Light)', 'pre-workout', '06:45',
 ...
 215, 6.2, 30, 7,
 25,
 'GOAL: Muscle Building. NOTES: Light on the stomach, sufficient carbs for moderate training. Peanuts slow digestion to extend energy. Good for morning workouts when a heavy meal causes discomfort. Eat 30 minutes before.'),
...
('Ragi (Finger Millet) Energy Balls', 'pre-workout', '06:30',
 ...
 220, 4.6, 39.5, 5.2,
 25,
 'GOAL: Muscle Building. NOTES: Traditional South Indian energy food. Ragi is slow-releasing complex carbohydrate G�� provides sustained energy throughout workout. Jaggery provides iron and quick-acting energy spike. Portable and storable for 3-4 days.'),
...
('Curd with Flattened Rice (Dahi Poha)', 'pre-workout', '07:00',
 ...
 230, 6, 37, 4.5,
 20,
 'GOAL: Muscle Building. NOTES: Traditional pre-workout meal popular in Maharashtra and Gujarat. Easy to digest, not heavy on stomach. Curd protein sustains muscle; poha carbs fuel the workout. Ideal for those who cannot eat heavy before exercise.'),
...
('Moong Dal Chilla (Small, Pre-Workout)', 'pre-workout', '06:45',
 ...
 95, 7.2, 16, 1.5,
 15,
 'GOAL: Muscle Building. NOTES: Minimal calorie, high protein, light on stomach. Ideal when working out within 30 minutes of waking. Provides amino acids without bloating. Good for fasted-state training with minimal fuel.'),
...
('Soya Milk with Banana Smoothie', 'post-workout', '09:00',
 ...
 237, 8.9, 39, 5.8,
 45,
 'GOAL: Muscle Building. NOTES: Soya milk provides complete plant protein; banana replenishes glycogen; chia adds omega-3 for recovery. Quick to prepare and easy to drink post-workout when appetite is suppressed. Suitable for lactose-intolerant individuals.'),
...
('Rajma Rice (Post-Workout Bulk)', 'post-workout', '09:30',
 ...
 555, 21, 101, 8.5,
 65,
 'GOAL: Muscle Building. NOTES: High protein, very high carb meal. White rice post-workout is ideal G�� its high glycaemic index rapidly replenishes muscle glycogen. Rajma provides slow-digesting plant protein. Excellent for evening post-workout meal for muscle gain.'),
...
('Dal Khichdi with Boiled Egg', 'post-workout', '09:00',
 ...
 470, 24.2, 57, 15.3,
 55,
 'GOAL: Muscle Building. NOTES: Khichdi alone is incomplete in protein G�� adding eggs bridges this gap. Gentle on digestive system post-training. Good protein-to-carb ratio for recovery. Suitable for morning or afternoon training sessions.'),
...
('Tuna (or Canned Fish) with Chapati', 'post-workout', '09:00',
 ...
 355, 36, 45, 5,
 90,
 'GOAL: Muscle Building. NOTES: Very high protein, lean post-workout meal. Canned fish is one of the most cost-effective protein sources in India. Omega-3 in tuna/sardines reduces exercise-induced inflammation. Chapati replenishes glycogen. Excellent for lean bulking.'),
...
('Sprouted Lentil Salad with Boiled Chicken', 'post-workout', '09:30',
 ...
 280, 39, 21, 4.1,
 95,
 'GOAL: Weight Loss. NOTES: Very high protein, very low calorie, low carb post-workout meal. Best for fat loss phases where carb restriction is maintained. Sprouts provide plant protein and live enzymes which speed recovery.'),

-- =============================================================================
-- ADDITIONAL BREAKFAST G�� Regional Indian
-- =============================================================================
...
('Uttapam with Coconut Chutney', 'breakfast', '08:30',
 ...
 310, 7, 43, 10.5,
 40,
 'GOAL: Maintaining Health. NOTES: Fermented batter provides probiotics. More filling than plain dosa due to thickness. Good for all age groups. Versatile vegetable toppings add micronutrients.'),
...
('Pesarattu (Green Moong Dosa)', 'breakfast', '08:00',
 ...
 228, 13.7, 33, 5.6,
 30,
 'MUSCLE BUILDING / HEALTH MAINTENANCE. Andhra/Telugu breakfast. Unlike rice dosas, pesarattu is made entirely from whole green moong G�� extremely high protein and fibre. One of the healthiest dosas in Indian cuisine. High in iron and folate.'),
...
('Akki Roti (Rice Flour Flatbread)', 'breakfast', '08:30',
 ...
 280, 4.7, 44.5, 8.8,
 25,
 'GOAL: Maintaining Health. NOTES: Karnataka breakfast. Gluten-free. Dill leaves are excellent for digestion and have anti-inflammatory properties. Coconut adds medium-chain triglycerides. Traditional and regional G�� good for micronutrient diversity.'),
...
('Thepla (Gujarati Flatbread)', 'breakfast', '08:30',
 ...
 280, 10.2, 43, 7.8,
 30,
 'GOAL: Maintaining Health. NOTES: Versatile, portable Gujarati flatbread. Stays fresh 3-4 days G�� great for meal prep. Methi and ajwain aid digestion. Curd in dough improves texture and adds probiotics.'),

-- =============================================================================
-- ADDITIONAL LUNCH G�� Regional and Varied
-- =============================================================================
...
('Kootu (South Indian Vegetable Lentil)', 'lunch', '13:00',
 ...
 390, 13.8, 52, 13.3,
 40,
 'GOAL: Maintaining Health. NOTES: Tamil Nadu staple. Provides protein, complex carbs and medium-chain fats from coconut. Raw banana (or yam) is rich in resistant starch which feeds gut bacteria. Excellent for digestive health.'),
...
('Pav Bhaji (Healthy Version)', 'lunch', '13:00',
 ...
 385, 12, 70, 9,
 60,
 'GOAL: Maintaining Health. NOTES: Popular Mumbai meal made healthier by using minimal butter and whole wheat bread. Loaded with vegetables. Good for days when you want satisfying comfort food within moderate calories.'),
...
('Rajasthani Dal Baati', 'lunch', '13:30',
 ...
 610, 22, 88, 20,
 75,
 'GOAL: Weight Gaining, Maintaining Health. NOTES: Traditional Rajasthani meal. Panchmel dal uses 5 varieties of lentils G�� exceptional protein and fibre diversity. High calorie. Excellent for labourers and highly active individuals. Rich in iron and zinc.'),
...
('Avial with Rice (Kerala)', 'lunch', '13:00',
 ...
 455, 10.5, 75, 13,
 55,
 'GOAL: Maintaining Health. NOTES: Kerala dish with extraordinary vegetable diversity in one preparation. Wide spectrum of vitamins and minerals. Coconut oil provides anti-microbial lauric acid. One of the most nutritionally diverse traditional Indian meals.'),

-- =============================================================================
-- ADDITIONAL SNACKS G�� Various Goals
-- =============================================================================
...
('Steamed Corn (Bhutta) with Spices', 'snack', '16:00',
 ...
 155, 4.5, 30, 3.7,
 20,
 'GOAL: Maintaining Health. NOTES: Traditional Indian street snack made healthy. Corn is rich in lutein and zeaxanthin for eye health. High fibre. Antioxidant-rich. Popular across all regions. Low calorie when minimally buttered.'),
...
('Kachumber Salad', 'snack', '16:00',
 ...
 58, 2.3, 12, 0.3,
 15,
 'FAT LOSS / HEALTH MAINTENANCE. Traditional Indian accompaniment eaten as a standalone snack. Very low calorie, high fibre and hydrating. Essential companion to rich meals for digestive balance. Eat as much as desired G�� virtually zero calories.'),
...
('Popcorn with Indian Spices', 'snack', '16:30',
 ...
 115, 3.2, 21, 2.2,
 15,
 'GOAL: Weight Loss. NOTES: Surprisingly high-volume, low-calorie snack. Air-popped popcorn is a whole grain and high-fibre. Indian spicing makes it far more satisfying than plain. Excellent for television/movie snacking during diet phase.'),
...
('Dhokla (Steamed Gram Flour Cake)', 'snack', '16:00',
 ...
 220, 11.2, 25.5, 7.5,
 25,
 'GOAL: Maintaining Health, Weight Loss. NOTES: Classic Gujarati snack. Steamed not fried G�� much lower calorie than deep-fried snacks. High protein from besan. Probiotics from fermented curd. Light and filling. Good for daily snacking.'),
...
('Rajgira (Amaranth) Chikki', 'snack', '17:00',
 ...
 180, 3.7, 41, 1.5,
 20,
 'HEALTH MAINTENANCE / WEIGHT GAIN. Rajgira (amaranth) is a complete protein grain G�� unusual in plant foods. Very rich in calcium, iron and magnesium. Traditional Navratri snack. High calorie from jaggery. Excellent for hair health and bone density.'),

-- =============================================================================
-- ADDITIONAL DINNER G�� Various
-- =============================================================================
...
('Masoor Dal with Spinach and Roti', 'dinner', '20:00',
 ...
 415, 20.5, 71.5, 7.2,
 35,
 'GOAL: Maintaining Health, Weight Loss. NOTES: Masoor dal cooks fastest of all dals G�� excellent for quick weeknight dinners. Red lentils are high in folate and iron. Spinach doubles the iron and folate content. Excellent anti-anaemia dinner.'),
...
('Gawar Phali (Cluster Beans) Sabzi with Dal', 'dinner', '20:00',
 ...
 455, 20.5, 78, 8.4,
 35,
 'HEALTH MAINTENANCE / DIABETES MANAGEMENT. Cluster beans (guar) are extraordinarily rich in soluble fibre, especially galactomannan G�� proven to reduce blood sugar and cholesterol. Very traditional, underused vegetable. Excellent for diabetics and anyone focused on gut health.'),
...
('Baingan Bharta with Roti', 'dinner', '20:00',
 ...
 'Roast whole eggplant directly on flame. Peel, mash. Saut+� with onion, tomato and spices.',
 350, 11.5, 61, 8.3,
 30,
 'GOAL: Maintaining Health, Weight Loss. NOTES: Smoke-roasted eggplant is rich in nasunin G�� a powerful brain-protecting antioxidant. Very low calorie. High fibre. The smoky flavour creates satisfaction without high calories. Classic North Indian home dinner.'),
...
('Kadhi Pakora with Rice', 'dinner', '20:00',
 ...
 520, 17.3, 74, 16.2,
 50,
 'GOAL: Maintaining Health. NOTES: Traditional comfort dinner from Punjab and Rajasthan. Curd-based kadhi is probiotic-rich and aids digestion. Fenugreek seeds in tempering reduce blood sugar. Moderate calorie G�� suitable for most goals. Weekend comfort meal.'),
...
('Jowar Bhakri with Shengdana Chutney', 'dinner', '19:30',
 ...
 295, 10.5, 42, 11,
 25,
 'GOAL: Maintaining Health, Weight Loss. NOTES: Traditional Maharashtrian dinner. Jowar (sorghum) is gluten-free, high in iron and resistant starch. Very high fibre. The peanut chutney provides protein and healthy fats. Simple, nutritious and affordable rural staple.'),
...
('Giloy (Heart-leaf Moonseed) Juice', 'snack', '07:00',
 ...
 45, 0.8, 11, 0.1,
 20,
 'HEALTH MAINTENANCE / IMMUNITY. Giloy is considered a divine herb in Ayurveda G�� proven adaptogen and immunomodulator. Reduces chronic inflammation and improves platelet count. Excellent during seasonal illness and for overall immunity maintenance. Drink 3-4 times per week.'),
...
('Lauki (Bottle Gourd) Mint Juice', 'snack', '07:00',
 ...
 31, 1.1, 7, 0.1,
 15,
 'WEIGHT LOSS / KIDNEY HEALTH. Lauki juice is one of the lowest calorie beverages possible. Extremely hydrating and alkalising. Supports kidney function and reduces cholesterol. Drink on empty stomach for best results. Note: Do NOT juice lauki if it tastes bitter G�� this indicates toxic cucurbitacin content.'),
...
('Tulsi Ginger Honey Kadha', 'snack', '07:00',
 ...
 40, 0.7, 9.8, 0.3,
 10,
 'HEALTH MAINTENANCE / IMMUNITY. Traditional Indian kadha consumed for centuries. Tulsi is the most revered medicinal herb in India G�� adaptogen, anti-viral, stress-reducer. Ginger is anti-inflammatory. Honey is antimicrobial. Excellent during change of seasons and as a daily immunity ritual.'),
...
('Banana Dates Jaggery Shake', 'snack', '16:00',
 ...
 287, 6.7, 56.5, 5.4,
 35,
 'GOAL: Weight Gaining. NOTES: Traditional high-energy Indian shake. Dates provide iron and fast carbs; jaggery provides iron and trace minerals; banana provides potassium. Natural alternative to commercial pre-workout drinks. Very popular among traditional athletes and wrestlers.')
